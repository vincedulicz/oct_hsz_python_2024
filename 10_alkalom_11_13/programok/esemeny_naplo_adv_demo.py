    ...
    try:
        with open("esemenyek.txt", "r+", encoding="utf+8") as file:
            ...
            if old_text not in content:
                raise InvalidDataException("Az esemény található")
...
def main():
    try:
        ...
        modify_event("adatfeltöltés", "adatFel")

        rename_file("uj_esemenyek.txt")

        # os.rename("uj_esemenyek.txt", "esemenyek.txt")
