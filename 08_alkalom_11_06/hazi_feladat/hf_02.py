# IP-cím osztályok határai és leírásai
class_a_range = (0, 127)
...
def create_ip_classes():
    ...
    return {
        label: {"range": ip_range, "description": description}
            for label, ip_range, description in zip(class_labels,
                                            [class_a_range, class_b_range,
                                             class_c_range, class_d_range,
                                             class_e_range],
                                            descriptions)
    }
